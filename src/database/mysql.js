...
export const MYSQL_SNIPPETS = [
    ...
    { trigger: 'jsonobj', name: 'JSON Object', template: 'SELECT JSON_OBJECT(\'key1\', ${1:val1}, \'key2\', ${2:val2}) as json_data', description: 'Create JSON object' },
    { trigger: 'jsonarr', name: 'JSON Array', template: 'SELECT JSON_ARRAY(${1:val1}, ${2:val2}, ${3:val3}) as json_array', description: 'Create JSON array' },
