...
export const ThemeManager = {
    ...
    DARK_THEMES: ['dark', 'oceanic', 'ember', 'aurora', 'neon', 'copper'],
    ...
    getCurrentTheme() {
        ...
        if (root.classList.contains(this.THEMES.COPPER)) return this.THEMES.COPPER;
        return this.THEMES.DARK;
    },
    ...
    backgrounds: {
        ...
        elevated: () => ThemeManager.getClasses({
            ...
            copper: 'bg-copper-panel shadow-2xl'
        }),
        input: () => ThemeManager.getClasses({
            ...
            copper: 'bg-copper-bg border-copper-border focus:border-copper-accent focus:shadow-[0_0_8px_rgba(205,127,50,0.3)]'
        })
    },
    ...
    borders: {
        ...
        subtle: () => ThemeManager.getClasses({
            ...
            copper: 'border-copper-border/50'
        }),
        accent: () => ThemeManager.getClasses({
            ...
            copper: 'border-copper-accent/50 shadow-[0_0_5px_rgba(205,127,50,0.2)]'
        })
    },
    ...
    buttons: {
        primary: () => ThemeManager.getClasses({
            ...
            copper: 'bg-copper-accent text-white hover:bg-copper-accent/90'
        }),
        secondary: () => ThemeManager.getClasses({
            ...
            copper: 'bg-copper-border/30 text-copper-text hover:bg-copper-border/50'
        }),
        ghost: () => ThemeManager.getClasses({
            ...
            copper: 'text-copper-text/70 hover:text-copper-text hover:bg-copper-border/30'
        }),
        danger: () => ThemeManager.getClasses({
            ...
            copper: 'bg-red-500/80 text-white hover:bg-red-500'
        })
    },
    ...
    cards: {
        default: () => ThemeManager.getClasses({
            ...
            copper: 'bg-copper-panel border border-copper-border rounded-lg'
        }),
        elevated: () => ThemeManager.getClasses({
            ...
            copper: 'bg-copper-panel rounded-lg shadow-2xl'
        }),
        interactive: () => ThemeManager.getClasses({
            ...
            copper: 'bg-copper-panel border border-copper-border rounded-lg hover:border-copper-accent/50 transition-colors'
        })
    },
    ...
    inputs: {
        text: () => ThemeManager.getClasses({
            ...
            copper: 'bg-copper-bg border border-copper-border text-copper-text placeholder-copper-text/50 focus:border-copper-accent focus:ring-1 focus:ring-copper-accent'
        }),
        select: () => ThemeManager.getClasses({
            ...
            copper: 'bg-copper-bg border border-copper-border text-copper-text'
        }),
        checkbox: () => ThemeManager.getClasses({
            ...
            copper: 'text-copper-accent bg-copper-bg border-copper-border focus:ring-copper-accent'
        })
    },
    ...
    badges: {
        default: () => ThemeManager.getClasses({
            ...
            copper: 'bg-copper-border/50 text-copper-text'
        }),
        success: () => ThemeManager.getClasses({
            ...
            copper: 'bg-green-500/20 text-green-400'
        }),
        warning: () => ThemeManager.getClasses({
            ...
            copper: 'bg-yellow-500/20 text-yellow-400'
        }),
        error: () => ThemeManager.getClasses({
            ...
            copper: 'bg-red-500/20 text-red-400'
        }),
        info: () => ThemeManager.getClasses({
            ...
            copper: 'bg-blue-500/20 text-blue-400'
        })
    },
    ...
    tables: {
        header: () => ThemeManager.getClasses({
            ...
            copper: 'bg-copper-bg text-copper-text/70 border-b border-copper-border'
        }),
        row: () => ThemeManager.getClasses({
            ...
            copper: 'border-b border-copper-border/30 hover:bg-copper-border/20'
        }),
    ...
    scrollbar: () => ThemeManager.getClasses({
        ...
        copper: 'scrollbar-thumb-copper-border scrollbar-track-transparent'
    }),
    ...
    tooltip: () => ThemeManager.getClasses({
        ...
        copper: 'bg-copper-panel text-copper-text border border-copper-border'
    }),
    ...
    toggle() {
        ...
        else if (current === this.THEMES.NEON) newTheme = this.THEMES.COPPER;
