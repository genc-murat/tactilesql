...
export class AskAiModal {
    static async show(onInsert) {
        ...
        modal.className = `${isLight ? 'bg-white border-gray-200' : (isDawn ? 'bg-[#fffaf3] border-[#f2e9e1]' : (isOceanicVariant ? 'bg-ocean-panel border-ocean-border/50' : 'bg-[#16191e] border border-white/10'))} rounded-xl shadow-2xl w-full max-w-lg transform scale-95 transition-transform duration-200 flex flex-col`;

        modal.innerHTML = `
            <div class="px-6 py-4 border-b ${isLight ? 'border-gray-100 bg-gray-50' : (isDawn ? 'border-[#f2e9e1] bg-[#faf4ed]' : (isOceanicVariant ? 'border-ocean-border/30 bg-ocean-panel' : 'border-white/5 bg-[#13161b]'))} rounded-t-xl flex items-center justify-between">
            ...
            <div class="px-6 py-4 border-t ${isLight ? 'border-gray-100 bg-gray-50' : (isDawn ? 'border-[#f2e9e1] bg-[#faf4ed]' : (isOceanicVariant ? 'border-ocean-border/30 bg-ocean-panel' : 'border-white/5 bg-[#13161b]'))} rounded-b-xl flex justify-end gap-3">
