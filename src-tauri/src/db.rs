...
const DATA_COMPARE_DEFAULT_MAX_ROWS: usize = 20_000;
const DATA_COMPARE_MAX_MAX_ROWS: usize = 500_000;
const DATA_COMPARE_DEFAULT_SAMPLE_LIMIT: usize = 50;
const DATA_COMPARE_MAX_SAMPLE_LIMIT: usize = 500;
const DATA_COMPARE_DEFAULT_STATEMENT_LIMIT: usize = 10_000;
const DATA_COMPARE_MAX_STATEMENT_LIMIT: usize = 200_000;

type DataRowMap = BTreeMap<String, serde_json::Value>;

#[derive(Clone)]
struct DataChangedRowInternal {
    source_row: DataRowMap,
    target_row: DataRowMap,
    changed_canonicals: Vec<String>,
}

struct DataCompareInternalResult {
    db_type: DatabaseType,
    source_database: String,
    source_table: String,
    target_database: String,
    target_table: String,
    key_canonicals: Vec<String>,
    compare_canonicals: Vec<String>,
    insert_canonicals: Vec<String>,
    output_name_by_canonical: HashMap<String, String>,
    target_name_by_canonical: HashMap<String, String>,
    summary: DataCompareSummary,
    missing_rows: Vec<DataRowMap>,
    extra_rows: Vec<DataRowMap>,
    changed_rows: Vec<DataChangedRowInternal>,
    warnings: Vec<String>,
}
...
fn parse_non_empty_field(label: &str, value: &str) -> Result<String, String> {
...
fn combine_canonicals(primary: &[String], secondary: &[String]) -> Vec<String> {
    let mut seen = HashSet::new();
...
fn parse_count_value(value: &serde_json::Value) -> Option<usize> {
    match value {
...
fn parse_count_from_results(results: Vec<QueryResult>, label: &str) -> Result<usize, String> {
...
fn build_row_key_token(row: &DataRowMap, key_canonicals: &[String]) -> Result<String, String> {
...
fn column_has_auto_generated_default(column: &ColumnSchema) -> bool {
...
fn build_insert_statement_for_row(
    db_type: &DatabaseType,
...
fn build_update_statement_for_row(
    db_type: &DatabaseType,
    qualified_target_table: &str,
    source_row: &DataRowMap,
...
fn build_delete_statement_for_row(
    db_type: &DatabaseType,
    qualified_target_table: &str,
    target_row: &DataRowMap,
    key_canonicals: &[String],
